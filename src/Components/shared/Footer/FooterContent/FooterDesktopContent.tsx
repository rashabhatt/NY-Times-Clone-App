...
export function FooterDesktopViewComponent() {
  return (
    <div>
      <Box>
                ...
                <Footer.Row>
                  <Footer.Column>
                    <span style={{ marginBottom: '5px', marginTop: '-5px' }}>
                      <Footer.Link2>
                        <h3>
                          <NewspaperIcon style={{ marginRight: '10px' }} /> Home
                          Delivery
                        </h3>
                      </Footer.Link2>
                    </span>
                    ...
                    <span style={{ marginBottom: '5px' }}>
                      <Footer.Link2>
                        <h3>
                          <GamesIcon style={{ marginRight: '10px' }} /> Games
                        </h3>
                      </Footer.Link2>
                    </span>
                    <span style={{ marginBottom: '3px' }}>
                      <Footer.Link2>
                        <h3>
                          <LocalDiningIcon style={{ marginRight: '10px' }} />{' '}
                          Cooking
                        </h3>
                      </Footer.Link2>
                    </span>

                    <Footer.List style={{ marginTop: '15px' }}>
